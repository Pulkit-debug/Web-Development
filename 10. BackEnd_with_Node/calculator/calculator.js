...
app.get("/", function(req, res) {
  res.sendFile(__dirname + "/index.html");  // __dirname will get the directory of current files doesn't matter whether the data is on the cloud or someone else computer
...
app.post("/", function(req, res) {
  ...
  req.send("The result of the Addition is " + result);
});
